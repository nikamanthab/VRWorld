...
class VideoControl extends React.PureComponent<VideoControlProps> {
  ...
  setMyState = ()=>{
    // this.setState(obj);
    // console.log("before:",this.state.nitin)
    // console.log("fuckkk riyaaaaaaaaaaaaaaaaa")
    peerAudioModule.kandavel(((a)=>{
      // console.log("threeeeeeeeeeeee someeeeeeeee")
      this.setState({
      nitin:a
    })}));
    // console.log("after:",this.state.nitin);
